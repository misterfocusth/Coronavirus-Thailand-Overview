...
export default function Past14DaysTestingChart(props) {
    ...
    var newConfirmedChart = {
        ...
        series: [{
            ...
            type: 'column',
            data: [props.testingData[props.testingData.length-13].tests, props.testingData[props.testingData.length-12].tests, props.testingData[props.testingData.length-11].tests, props.testingData[props.testingData.length-10].tests, props.testingData[props.testingData.length-9].tests, props.testingData[props.testingData.length-8].tests, props.testingData[props.testingData.length-7].tests, props.testingData[props.testingData.length-6].tests, props.testingData[props.testingData.length-5].tests, props.testingData[props.testingData.length-4].tests, props.testingData[props.testingData.length-3].tests, props.testingData[props.testingData.length-2].tests, props.testingData[props.testingData.length-1].tests],
        }, {
            name: 'ผลการตรวจเป็นบวก Positive (พบเชื้อโควิด-19)',
            type: 'column',
            data: [props.testingData[props.testingData.length-13].positive, props.testingData[props.testingData.length-12].positive, props.testingData[props.testingData.length-11].positive, props.testingData[props.testingData.length-10].positive, props.testingData[props.testingData.length-9].positive, props.testingData[props.testingData.length-8].positive, props.testingData[props.testingData.length-7].positive, props.testingData[props.testingData.length-6].positive, props.testingData[props.testingData.length-5].positive, props.testingData[props.testingData.length-4].positive, props.testingData[props.testingData.length-3].positive, props.testingData[props.testingData.length-2].positive, props.testingData[props.testingData.length-1].positive],
        }, 
        // {
